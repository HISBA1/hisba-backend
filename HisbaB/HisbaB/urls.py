...
from api.views import  RecentOrdersView, ApplyPromoCodeView,CalculateDeliveryFeeView ,AdminPromoCodeViewSet,RecommendStoresView , RecommendProductsView ,RecentUsersView, UserDetailView, RecentStoreRequestsView ,SalesReportView,UserActivityReportView,TopRatedStoresReportView,MostOrderedProductsReportView,StoreRequestsReportListView,ApproveStoreRequestReportView
...
urlpatterns = [
    ...
    path('api/admin/promo-codes/', AdminPromoCodeViewSet.as_view({'get': 'list', 'post': 'create'}), name='promo-code-list-create'),
    path('api/admin/promo-codes/<int:pk>/', AdminPromoCodeViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='promo-code-detail'),
    path('api/admin/promo-codes/<int:pk>/deactivate/', AdminPromoCodeViewSet.as_view({'post': 'deactivate'}), name='promo-code-deactivate'),
    path('api/admin/promo-codes/<int:pk>/activate/', AdminPromoCodeViewSet.as_view({'post': 'activate'}), name='promo-code-activate'),
    path('api/promo-codes/apply/', ApplyPromoCodeView.as_view({'post': 'apply'}), name='apply-promo-code'),
    ...
    path('api/recommendations/', RecommendProductsView.as_view(), name='recommend-products'),
    path('api/recommend-stores/', RecommendStoresView.as_view(), name='recommend-stores'),

    path('api/calculate-delivery-fee/', CalculateDeliveryFeeView.as_view(), name='calculate-delivery-fee'),
